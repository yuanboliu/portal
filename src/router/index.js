...
export const asyncRouterMap = [
...

  {
    ...
    children: [{
      path: 'index',
      component: _import('dataManage/index'),
      name: 'dataManage',
      meta: { title: 'dataManage', icon: 'icon', noCache: true }
    }]
  },

  {
    ...
    children: [{
      path: 'index',
      component: _import('computing/index'),
      name: 'computing',
      meta: { title: 'computing', icon: 'icon', noCache: true }
    }]
  },

  {
    ...
    children: [
      { path: 'wordHuisu', component: _import('huisu/wordHuisu'), name: 'wordHuisu', meta: { title: 'wordHuisu', noCache: true }},
      { path: 'picHuisu', component: _import('huisu/picHuisu'), name: 'picHuisu', meta: { title: 'picHuisu', noCache: true }},
      { path: 'videoHuisu', component: _import('huisu/videoHuisu'), name: 'videoHuisu', meta: { title: 'videoHuisu', noCache: true }},
      { path: 'adminHuisu', component: _import('huisu/adminHuisu'), name: 'adminHuisu', meta: { title: 'adminHuisu', noCache: true }}
    ]
  },
