  ...
  <el-row class="panel-group" :gutter="40">
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class='card-panel' @click="handleSetLineChartData('newVisitis')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">提交任务数</div>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">已使用容量</div>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" >
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">计算消耗</div>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">整体打分</div>
          <count-to class="card-panel-num" :startVal="0" :endVal="60" :duration="3600"></count-to>
        </div>
      </div>
    </el-col>
  </el-row>
